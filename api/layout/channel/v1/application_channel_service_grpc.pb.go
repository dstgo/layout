...
const (
	Channel_ListChannelType_FullMethodName = "/layout.api.layout.channel.v1.Channel/ListChannelType"
	Channel_ListChannel_FullMethodName     = "/layout.api.layout.channel.v1.Channel/ListChannel"
	Channel_CreateChannel_FullMethodName   = "/layout.api.layout.channel.v1.Channel/CreateChannel"
	Channel_UpdateChannel_FullMethodName   = "/layout.api.layout.channel.v1.Channel/UpdateChannel"
	Channel_DeleteChannel_FullMethodName   = "/layout.api.layout.channel.v1.Channel/DeleteChannel"
)
...
var Channel_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "layout.api.layout.channel.v1.Channel",
	...
	Metadata: "api/layout/channel/application_channel_service.proto",
}
