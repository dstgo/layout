...
const OperationChannelCreateChannel = "/layout.api.layout.channel.v1.Channel/CreateChannel"
const OperationChannelDeleteChannel = "/layout.api.layout.channel.v1.Channel/DeleteChannel"
const OperationChannelListChannel = "/layout.api.layout.channel.v1.Channel/ListChannel"
const OperationChannelListChannelType = "/layout.api.layout.channel.v1.Channel/ListChannelType"
const OperationChannelUpdateChannel = "/layout.api.layout.channel.v1.Channel/UpdateChannel"
...
func RegisterChannelHTTPServer(s *http.Server, srv ChannelHTTPServer) {
	r := s.Route("/")
	r.GET("/layout/api/v1/channel/types", _Channel_ListChannelType0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/channels", _Channel_ListChannel0_HTTP_Handler(srv))
	r.POST("/layout/api/v1/channel", _Channel_CreateChannel0_HTTP_Handler(srv))
	r.PUT("/layout/api/v1/channel", _Channel_UpdateChannel0_HTTP_Handler(srv))
	r.DELETE("/layout/api/v1/channel", _Channel_DeleteChannel0_HTTP_Handler(srv))
}
...
func (c *ChannelHTTPClientImpl) ListChannel(ctx context.Context, in *ListChannelRequest, opts ...http.CallOption) (*ListChannelReply, error) {
	...
	pattern := "/layout/api/v1/channels"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *ChannelHTTPClientImpl) ListChannelType(ctx context.Context, in *ListChannelTypeRequest, opts ...http.CallOption) (*ListChannelTypeReply, error) {
	...
	pattern := "/layout/api/v1/channel/types"
	path := binding.EncodeURL(pattern, in, true)
