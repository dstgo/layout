...
const OperationUserinfoCreateUserinfo = "/layout.api.layout.userinfo.v1.Userinfo/CreateUserinfo"
const OperationUserinfoDeleteUserinfo = "/layout.api.layout.userinfo.v1.Userinfo/DeleteUserinfo"
const OperationUserinfoListUserinfo = "/layout.api.layout.userinfo.v1.Userinfo/ListUserinfo"
const OperationUserinfoUpdateUserinfo = "/layout.api.layout.userinfo.v1.Userinfo/UpdateUserinfo"
...
func RegisterUserinfoHTTPServer(s *http.Server, srv UserinfoHTTPServer) {
	r := s.Route("/")
	r.GET("/layout/api/v1/userinfoes", _Userinfo_ListUserinfo0_HTTP_Handler(srv))
	r.POST("/layout/api/v1/userinfo", _Userinfo_CreateUserinfo0_HTTP_Handler(srv))
	r.PUT("/layout/api/v1/userinfo", _Userinfo_UpdateUserinfo0_HTTP_Handler(srv))
	r.DELETE("/layout/api/v1/userinfo", _Userinfo_DeleteUserinfo0_HTTP_Handler(srv))
}
...
func (c *UserinfoHTTPClientImpl) CreateUserinfo(ctx context.Context, in *CreateUserinfoRequest, opts ...http.CallOption) (*CreateUserinfoReply, error) {
	...
	pattern := "/layout/api/v1/userinfo"
...
func (c *UserinfoHTTPClientImpl) ListUserinfo(ctx context.Context, in *ListUserinfoRequest, opts ...http.CallOption) (*ListUserinfoReply, error) {
	...
	pattern := "/layout/api/v1/userinfoes"
	path := binding.EncodeURL(pattern, in, true)
