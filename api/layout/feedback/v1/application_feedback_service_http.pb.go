...
const OperationFeedbackCreateFeedback = "/layout.api.layout.feedback.v1.Feedback/CreateFeedback"
const OperationFeedbackCreateFeedbackCategory = "/layout.api.layout.feedback.v1.Feedback/CreateFeedbackCategory"
const OperationFeedbackDeleteFeedback = "/layout.api.layout.feedback.v1.Feedback/DeleteFeedback"
const OperationFeedbackDeleteFeedbackCategory = "/layout.api.layout.feedback.v1.Feedback/DeleteFeedbackCategory"
const OperationFeedbackListFeedback = "/layout.api.layout.feedback.v1.Feedback/ListFeedback"
const OperationFeedbackListFeedbackCategory = "/layout.api.layout.feedback.v1.Feedback/ListFeedbackCategory"
const OperationFeedbackUpdateFeedback = "/layout.api.layout.feedback.v1.Feedback/UpdateFeedback"
const OperationFeedbackUpdateFeedbackCategory = "/layout.api.layout.feedback.v1.Feedback/UpdateFeedbackCategory"
...
func RegisterFeedbackHTTPServer(s *http.Server, srv FeedbackHTTPServer) {
	r := s.Route("/")
	r.GET("/layout/client/v1/feedback_categories", _Feedback_ListFeedbackCategory0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/feedback_categories", _Feedback_ListFeedbackCategory1_HTTP_Handler(srv))
	r.POST("/layout/api/v1/feedback_category", _Feedback_CreateFeedbackCategory0_HTTP_Handler(srv))
	r.PUT("/layout/api/v1/feedback_category", _Feedback_UpdateFeedbackCategory0_HTTP_Handler(srv))
	r.DELETE("/layout/api/v1/feedback_category", _Feedback_DeleteFeedbackCategory0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/feedbacks", _Feedback_ListFeedback0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/feedback", _Feedback_CreateFeedback0_HTTP_Handler(srv))
	r.DELETE("/layout/api/v1/feedback", _Feedback_DeleteFeedback0_HTTP_Handler(srv))
	r.PUT("/layout/api/v1/feedback", _Feedback_UpdateFeedback0_HTTP_Handler(srv))
}
...
func (c *FeedbackHTTPClientImpl) CreateFeedback(ctx context.Context, in *CreateFeedbackRequest, opts ...http.CallOption) (*CreateFeedbackReply, error) {
	...
	pattern := "/layout/client/v1/feedback"
...
func (c *FeedbackHTTPClientImpl) CreateFeedbackCategory(ctx context.Context, in *CreateFeedbackCategoryRequest, opts ...http.CallOption) (*CreateFeedbackCategoryReply, error) {
	...
	pattern := "/layout/api/v1/feedback_category"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *FeedbackHTTPClientImpl) DeleteFeedback(ctx context.Context, in *DeleteFeedbackRequest, opts ...http.CallOption) (*DeleteFeedbackReply, error) {
	...
	pattern := "/layout/api/v1/feedback"
...
func (c *FeedbackHTTPClientImpl) ListFeedback(ctx context.Context, in *ListFeedbackRequest, opts ...http.CallOption) (*ListFeedbackReply, error) {
	...
	pattern := "/layout/api/v1/feedbacks"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *FeedbackHTTPClientImpl) ListFeedbackCategory(ctx context.Context, in *ListFeedbackCategoryRequest, opts ...http.CallOption) (*ListFeedbackCategoryReply, error) {
	...
	pattern := "/layout/api/v1/feedback_categories"
	path := binding.EncodeURL(pattern, in, true)
