...
// 	protoc        v4.24.4
// source: api/layout/user/application_user_service.proto
...
var file_api_application_user_application_user_service_proto_goTypes = []interface{}{
	...
	(*UpdateCurrentUserRequest)(nil), // 1: layout.api.layout.user.v1.UpdateCurrentUserRequest
	(*GetUserRequest)(nil),           // 2: layout.api.layout.user.v1.GetUserRequest
	(*ListUserRequest)(nil),          // 3: layout.api.layout.user.v1.ListUserRequest
	(*CreateUserRequest)(nil),        // 4: layout.api.layout.user.v1.CreateUserRequest
	(*ImportUserRequest)(nil),        // 5: layout.api.layout.user.v1.ImportUserRequest
	(*ExportUserRequest)(nil),        // 6: layout.api.layout.user.v1.ExportUserRequest
	(*UpdateUserRequest)(nil),        // 7: layout.api.layout.user.v1.UpdateUserRequest
	(*UpdateUserStatusRequest)(nil),  // 8: layout.api.layout.user.v1.UpdateUserStatusRequest
	(*DeleteUserRequest)(nil),        // 9: layout.api.layout.user.v1.DeleteUserRequest
	(*GetTrashUserRequest)(nil),      // 10: layout.api.layout.user.v1.GetTrashUserRequest
	(*ListTrashUserRequest)(nil),     // 11: layout.api.layout.user.v1.ListTrashUserRequest
	(*DeleteTrashUserRequest)(nil),   // 12: layout.api.layout.user.v1.DeleteTrashUserRequest
	(*RevertTrashUserRequest)(nil),   // 13: layout.api.layout.user.v1.RevertTrashUserRequest
	(*GetCurrentUserReply)(nil),      // 14: layout.api.layout.user.v1.GetCurrentUserReply
	(*UpdateCurrentUserReply)(nil),   // 15: layout.api.layout.user.v1.UpdateCurrentUserReply
	(*GetUserReply)(nil),             // 16: layout.api.layout.user.v1.GetUserReply
	(*ListUserReply)(nil),            // 17: layout.api.layout.user.v1.ListUserReply
	(*CreateUserReply)(nil),          // 18: layout.api.layout.user.v1.CreateUserReply
	(*ImportUserReply)(nil),          // 19: layout.api.layout.user.v1.ImportUserReply
	(*ExportUserReply)(nil),          // 20: layout.api.layout.user.v1.ExportUserReply
	(*UpdateUserReply)(nil),          // 21: layout.api.layout.user.v1.UpdateUserReply
	(*UpdateUserStatusReply)(nil),    // 22: layout.api.layout.user.v1.UpdateUserStatusReply
	(*DeleteUserReply)(nil),          // 23: layout.api.layout.user.v1.DeleteUserReply
	(*GetTrashUserReply)(nil),        // 24: layout.api.layout.user.v1.GetTrashUserReply
	(*ListTrashUserReply)(nil),       // 25: layout.api.layout.user.v1.ListTrashUserReply
	(*DeleteTrashUserReply)(nil),     // 26: layout.api.layout.user.v1.DeleteTrashUserReply
...
var file_api_application_user_application_user_service_proto_depIdxs = []int32{
	0,  // 0: layout.api.layout.user.v1.User.GetCurrentUser:input_type -> layout.api.layout.user.v1.GetCurrentUserRequest
	1,  // 1: layout.api.layout.user.v1.User.UpdateCurrentUser:input_type -> layout.api.layout.user.v1.UpdateCurrentUserRequest
	2,  // 2: layout.api.layout.user.v1.User.GetUser:input_type -> layout.api.layout.user.v1.GetUserRequest
	3,  // 3: layout.api.layout.user.v1.User.ListUser:input_type -> layout.api.layout.user.v1.ListUserRequest
	4,  // 4: layout.api.layout.user.v1.User.CreateUser:input_type -> layout.api.layout.user.v1.CreateUserRequest
	5,  // 5: layout.api.layout.user.v1.User.ImportUser:input_type -> layout.api.layout.user.v1.ImportUserRequest
	6,  // 6: layout.api.layout.user.v1.User.ExportUser:input_type -> layout.api.layout.user.v1.ExportUserRequest
	7,  // 7: layout.api.layout.user.v1.User.UpdateUser:input_type -> layout.api.layout.user.v1.UpdateUserRequest
	8,  // 8: layout.api.layout.user.v1.User.UpdateUserStatus:input_type -> layout.api.layout.user.v1.UpdateUserStatusRequest
	9,  // 9: layout.api.layout.user.v1.User.DeleteUser:input_type -> layout.api.layout.user.v1.DeleteUserRequest
	10, // 10: layout.api.layout.user.v1.User.GetTrashUser:input_type -> layout.api.layout.user.v1.GetTrashUserRequest
	11, // 11: layout.api.layout.user.v1.User.ListTrashUser:input_type -> layout.api.layout.user.v1.ListTrashUserRequest
	12, // 12: layout.api.layout.user.v1.User.DeleteTrashUser:input_type -> layout.api.layout.user.v1.DeleteTrashUserRequest
	13, // 13: layout.api.layout.user.v1.User.RevertTrashUser:input_type -> layout.api.layout.user.v1.RevertTrashUserRequest
	14, // 14: layout.api.layout.user.v1.User.GetCurrentUser:output_type -> layout.api.layout.user.v1.GetCurrentUserReply
	15, // 15: layout.api.layout.user.v1.User.UpdateCurrentUser:output_type -> layout.api.layout.user.v1.UpdateCurrentUserReply
	16, // 16: layout.api.layout.user.v1.User.GetUser:output_type -> layout.api.layout.user.v1.GetUserReply
	17, // 17: layout.api.layout.user.v1.User.ListUser:output_type -> layout.api.layout.user.v1.ListUserReply
	18, // 18: layout.api.layout.user.v1.User.CreateUser:output_type -> layout.api.layout.user.v1.CreateUserReply
	19, // 19: layout.api.layout.user.v1.User.ImportUser:output_type -> layout.api.layout.user.v1.ImportUserReply
	20, // 20: layout.api.layout.user.v1.User.ExportUser:output_type -> layout.api.layout.user.v1.ExportUserReply
	21, // 21: layout.api.layout.user.v1.User.UpdateUser:output_type -> layout.api.layout.user.v1.UpdateUserReply
	22, // 22: layout.api.layout.user.v1.User.UpdateUserStatus:output_type -> layout.api.layout.user.v1.UpdateUserStatusReply
	23, // 23: layout.api.layout.user.v1.User.DeleteUser:output_type -> layout.api.layout.user.v1.DeleteUserReply
	24, // 24: layout.api.layout.user.v1.User.GetTrashUser:output_type -> layout.api.layout.user.v1.GetTrashUserReply
	25, // 25: layout.api.layout.user.v1.User.ListTrashUser:output_type -> layout.api.layout.user.v1.ListTrashUserReply
	26, // 26: layout.api.layout.user.v1.User.DeleteTrashUser:output_type -> layout.api.layout.user.v1.DeleteTrashUserReply
	27, // 27: layout.api.layout.user.v1.User.RevertTrashUser:output_type -> layout.api.layout.user.v1.RevertTrashUserReply
