...
const (
	User_GetCurrentUser_FullMethodName    = "/layout.api.layout.user.v1.User/GetCurrentUser"
	User_UpdateCurrentUser_FullMethodName = "/layout.api.layout.user.v1.User/UpdateCurrentUser"
	User_GetUser_FullMethodName           = "/layout.api.layout.user.v1.User/GetUser"
	User_ListUser_FullMethodName          = "/layout.api.layout.user.v1.User/ListUser"
	User_CreateUser_FullMethodName        = "/layout.api.layout.user.v1.User/CreateUser"
	User_ImportUser_FullMethodName        = "/layout.api.layout.user.v1.User/ImportUser"
	User_ExportUser_FullMethodName        = "/layout.api.layout.user.v1.User/ExportUser"
	User_UpdateUser_FullMethodName        = "/layout.api.layout.user.v1.User/UpdateUser"
	User_UpdateUserStatus_FullMethodName  = "/layout.api.layout.user.v1.User/UpdateUserStatus"
	User_DeleteUser_FullMethodName        = "/layout.api.layout.user.v1.User/DeleteUser"
	User_GetTrashUser_FullMethodName      = "/layout.api.layout.user.v1.User/GetTrashUser"
	User_ListTrashUser_FullMethodName     = "/layout.api.layout.user.v1.User/ListTrashUser"
	User_DeleteTrashUser_FullMethodName   = "/layout.api.layout.user.v1.User/DeleteTrashUser"
	User_RevertTrashUser_FullMethodName   = "/layout.api.layout.user.v1.User/RevertTrashUser"
)
...
var User_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "layout.api.layout.user.v1.User",
	...
	Metadata: "api/layout/user/application_user_service.proto",
}
