...
const OperationUserCreateUser = "/layout.api.layout.user.v1.User/CreateUser"
const OperationUserDeleteTrashUser = "/layout.api.layout.user.v1.User/DeleteTrashUser"
const OperationUserDeleteUser = "/layout.api.layout.user.v1.User/DeleteUser"
const OperationUserExportUser = "/layout.api.layout.user.v1.User/ExportUser"
const OperationUserGetCurrentUser = "/layout.api.layout.user.v1.User/GetCurrentUser"
const OperationUserGetTrashUser = "/layout.api.layout.user.v1.User/GetTrashUser"
const OperationUserGetUser = "/layout.api.layout.user.v1.User/GetUser"
const OperationUserImportUser = "/layout.api.layout.user.v1.User/ImportUser"
const OperationUserListTrashUser = "/layout.api.layout.user.v1.User/ListTrashUser"
const OperationUserListUser = "/layout.api.layout.user.v1.User/ListUser"
const OperationUserRevertTrashUser = "/layout.api.layout.user.v1.User/RevertTrashUser"
const OperationUserUpdateCurrentUser = "/layout.api.layout.user.v1.User/UpdateCurrentUser"
const OperationUserUpdateUser = "/layout.api.layout.user.v1.User/UpdateUser"
const OperationUserUpdateUserStatus = "/layout.api.layout.user.v1.User/UpdateUserStatus"
...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.GET("/layout/client/v1/user", _User_GetCurrentUser0_HTTP_Handler(srv))
	r.PUT("/layout/client/v1/user", _User_UpdateCurrentUser0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/user", _User_GetUser0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/users", _User_ListUser0_HTTP_Handler(srv))
	r.POST("/layout/api/v1/user", _User_CreateUser0_HTTP_Handler(srv))
	r.POST("/layout/api/v1/user/import", _User_ImportUser0_HTTP_Handler(srv))
	r.POST("/layout/api/v1/user/export", _User_ExportUser0_HTTP_Handler(srv))
	r.PUT("/layout/api/v1/user", _User_UpdateUser0_HTTP_Handler(srv))
	r.PUT("/layout/api/v1/user/status", _User_UpdateUserStatus0_HTTP_Handler(srv))
	r.DELETE("/layout/api/v1/user", _User_DeleteUser0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/user/trash", _User_GetTrashUser0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/user/trashes", _User_ListTrashUser0_HTTP_Handler(srv))
	r.DELETE("/layout/api/v1/user/trash", _User_DeleteTrashUser0_HTTP_Handler(srv))
	r.PUT("/layout/api/v1/user/trash", _User_RevertTrashUser0_HTTP_Handler(srv))
}
...
func (c *UserHTTPClientImpl) DeleteTrashUser(ctx context.Context, in *DeleteTrashUserRequest, opts ...http.CallOption) (*DeleteTrashUserReply, error) {
	...
	pattern := "/layout/api/v1/user/trash"
...
func (c *UserHTTPClientImpl) ExportUser(ctx context.Context, in *ExportUserRequest, opts ...http.CallOption) (*ExportUserReply, error) {
	...
	pattern := "/layout/api/v1/user/export"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *UserHTTPClientImpl) ImportUser(ctx context.Context, in *ImportUserRequest, opts ...http.CallOption) (*ImportUserReply, error) {
	...
	pattern := "/layout/api/v1/user/import"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *UserHTTPClientImpl) ListTrashUser(ctx context.Context, in *ListTrashUserRequest, opts ...http.CallOption) (*ListTrashUserReply, error) {
	...
	pattern := "/layout/api/v1/user/trashes"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *UserHTTPClientImpl) UpdateUserStatus(ctx context.Context, in *UpdateUserStatusRequest, opts ...http.CallOption) (*UpdateUserStatusReply, error) {
	...
	pattern := "/layout/api/v1/user/status"
	path := binding.EncodeURL(pattern, in, false)
