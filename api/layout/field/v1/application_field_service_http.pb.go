...
const OperationFieldCreateField = "/layout.api.layout.field.v1.Field/CreateField"
const OperationFieldDeleteField = "/layout.api.layout.field.v1.Field/DeleteField"
const OperationFieldListField = "/layout.api.layout.field.v1.Field/ListField"
const OperationFieldListFieldType = "/layout.api.layout.field.v1.Field/ListFieldType"
const OperationFieldUpdateField = "/layout.api.layout.field.v1.Field/UpdateField"
...
func RegisterFieldHTTPServer(s *http.Server, srv FieldHTTPServer) {
	r := s.Route("/")
	r.GET("/layout/api/v1/field/types", _Field_ListFieldType0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/fields", _Field_ListField0_HTTP_Handler(srv))
	r.POST("/layout/api/v1/field", _Field_CreateField0_HTTP_Handler(srv))
	r.PUT("/layout/api/v1/field", _Field_UpdateField0_HTTP_Handler(srv))
	r.DELETE("/layout/api/v1/field", _Field_DeleteField0_HTTP_Handler(srv))
}
...
func (c *FieldHTTPClientImpl) ListFieldType(ctx context.Context, in *ListFieldTypeRequest, opts ...http.CallOption) (*ListFieldTypeReply, error) {
	...
	pattern := "/layout/api/v1/field/types"
	path := binding.EncodeURL(pattern, in, true)
