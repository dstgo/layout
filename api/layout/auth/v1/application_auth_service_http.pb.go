...
const OperationAuthAuth = "/layout.api.layout.auth.v1.Auth/Auth"
const OperationAuthCreateAuth = "/layout.api.layout.auth.v1.Auth/CreateAuth"
const OperationAuthDeleteAuth = "/layout.api.layout.auth.v1.Auth/DeleteAuth"
const OperationAuthDeleteOAuth = "/layout.api.layout.auth.v1.Auth/DeleteOAuth"
const OperationAuthEmailBind = "/layout.api.layout.auth.v1.Auth/EmailBind"
const OperationAuthEmailLogin = "/layout.api.layout.auth.v1.Auth/EmailLogin"
const OperationAuthEmailRegister = "/layout.api.layout.auth.v1.Auth/EmailRegister"
const OperationAuthGenAuthCaptcha = "/layout.api.layout.auth.v1.Auth/GenAuthCaptcha"
const OperationAuthListAuth = "/layout.api.layout.auth.v1.Auth/ListAuth"
const OperationAuthListOAuth = "/layout.api.layout.auth.v1.Auth/ListOAuth"
const OperationAuthLogout = "/layout.api.layout.auth.v1.Auth/Logout"
const OperationAuthOAuthLogin = "/layout.api.layout.auth.v1.Auth/OAuthLogin"
const OperationAuthPasswordBind = "/layout.api.layout.auth.v1.Auth/PasswordBind"
const OperationAuthPasswordLogin = "/layout.api.layout.auth.v1.Auth/PasswordLogin"
const OperationAuthPasswordRegister = "/layout.api.layout.auth.v1.Auth/PasswordRegister"
const OperationAuthRefreshToken = "/layout.api.layout.auth.v1.Auth/RefreshToken"
const OperationAuthUpdateAuthStatus = "/layout.api.layout.auth.v1.Auth/UpdateAuthStatus"
...
func RegisterAuthHTTPServer(s *http.Server, srv AuthHTTPServer) {
	r := s.Route("/")
	r.POST("/layout/client/v1/token/refresh", _Auth_RefreshToken0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/logout", _Auth_Logout0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/auth", _Auth_Auth0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/auths", _Auth_ListAuth0_HTTP_Handler(srv))
	r.POST("/layout/api/v1/auth", _Auth_CreateAuth0_HTTP_Handler(srv))
	r.PUT("/layout/api/v1/auth/status", _Auth_UpdateAuthStatus0_HTTP_Handler(srv))
	r.DELETE("/layout/api/v1/auth", _Auth_DeleteAuth0_HTTP_Handler(srv))
	r.GET("/layout/api/v1/oauths", _Auth_ListOAuth0_HTTP_Handler(srv))
	r.DELETE("/layout/api/v1/oauth", _Auth_DeleteOAuth0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/auth/captcha", _Auth_GenAuthCaptcha0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/login/oauth", _Auth_OAuthLogin0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/login/email", _Auth_EmailLogin0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/login/password", _Auth_PasswordLogin0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/register/email", _Auth_EmailRegister0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/register/password", _Auth_PasswordRegister0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/bind/email", _Auth_EmailBind0_HTTP_Handler(srv))
	r.POST("/layout/client/v1/bind/password", _Auth_PasswordBind0_HTTP_Handler(srv))
}
...
func (c *AuthHTTPClientImpl) EmailBind(ctx context.Context, in *EmailBindRequest, opts ...http.CallOption) (*EmailBindReply, error) {
	...
	pattern := "/layout/client/v1/bind/email"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthHTTPClientImpl) EmailLogin(ctx context.Context, in *EmailLoginRequest, opts ...http.CallOption) (*EmailLoginReply, error) {
	...
	pattern := "/layout/client/v1/login/email"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthHTTPClientImpl) EmailRegister(ctx context.Context, in *EmailRegisterRequest, opts ...http.CallOption) (*EmailRegisterReply, error) {
	...
	pattern := "/layout/client/v1/register/email"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthHTTPClientImpl) GenAuthCaptcha(ctx context.Context, in *GenAuthCaptchaRequest, opts ...http.CallOption) (*GenAuthCaptchaReply, error) {
	...
	pattern := "/layout/client/v1/auth/captcha"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthHTTPClientImpl) Logout(ctx context.Context, in *LogoutRequest, opts ...http.CallOption) (*LogoutReply, error) {
	var out LogoutReply
	pattern := "/layout/client/v1/logout"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *AuthHTTPClientImpl) OAuthLogin(ctx context.Context, in *OAuthLoginRequest, opts ...http.CallOption) (*OAuthLoginReply, error) {
	...
	pattern := "/layout/client/v1/login/oauth"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthHTTPClientImpl) PasswordBind(ctx context.Context, in *PasswordBindRequest, opts ...http.CallOption) (*PasswordBindReply, error) {
	...
	pattern := "/layout/client/v1/bind/password"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthHTTPClientImpl) PasswordLogin(ctx context.Context, in *PasswordLoginRequest, opts ...http.CallOption) (*PasswordLoginReply, error) {
	...
	pattern := "/layout/client/v1/login/password"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthHTTPClientImpl) PasswordRegister(ctx context.Context, in *PasswordRegisterRequest, opts ...http.CallOption) (*PasswordRegisterReply, error) {
	...
	pattern := "/layout/client/v1/register/password"
	path := binding.EncodeURL(pattern, in, false)
...
func (c *AuthHTTPClientImpl) RefreshToken(ctx context.Context, in *RefreshTokenRequest, opts ...http.CallOption) (*RefreshTokenReply, error) {
	...
	pattern := "/layout/client/v1/token/refresh"
	path := binding.EncodeURL(pattern, in, true)
...
func (c *AuthHTTPClientImpl) UpdateAuthStatus(ctx context.Context, in *UpdateAuthStatusRequest, opts ...http.CallOption) (*UpdateAuthStatusReply, error) {
	...
	pattern := "/layout/api/v1/auth/status"
	path := binding.EncodeURL(pattern, in, false)
