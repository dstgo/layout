...
const (
	Auth_RefreshToken_FullMethodName     = "/layout.api.layout.auth.v1.Auth/RefreshToken"
	Auth_Logout_FullMethodName           = "/layout.api.layout.auth.v1.Auth/Logout"
	Auth_Auth_FullMethodName             = "/layout.api.layout.auth.v1.Auth/Auth"
	Auth_ListAuth_FullMethodName         = "/layout.api.layout.auth.v1.Auth/ListAuth"
	Auth_CreateAuth_FullMethodName       = "/layout.api.layout.auth.v1.Auth/CreateAuth"
	Auth_UpdateAuthStatus_FullMethodName = "/layout.api.layout.auth.v1.Auth/UpdateAuthStatus"
	Auth_DeleteAuth_FullMethodName       = "/layout.api.layout.auth.v1.Auth/DeleteAuth"
	Auth_ListOAuth_FullMethodName        = "/layout.api.layout.auth.v1.Auth/ListOAuth"
	Auth_DeleteOAuth_FullMethodName      = "/layout.api.layout.auth.v1.Auth/DeleteOAuth"
	Auth_GenAuthCaptcha_FullMethodName   = "/layout.api.layout.auth.v1.Auth/GenAuthCaptcha"
	Auth_OAuthLogin_FullMethodName       = "/layout.api.layout.auth.v1.Auth/OAuthLogin"
	Auth_EmailLogin_FullMethodName       = "/layout.api.layout.auth.v1.Auth/EmailLogin"
	Auth_PasswordLogin_FullMethodName    = "/layout.api.layout.auth.v1.Auth/PasswordLogin"
	Auth_EmailRegister_FullMethodName    = "/layout.api.layout.auth.v1.Auth/EmailRegister"
	Auth_PasswordRegister_FullMethodName = "/layout.api.layout.auth.v1.Auth/PasswordRegister"
	Auth_EmailBind_FullMethodName        = "/layout.api.layout.auth.v1.Auth/EmailBind"
	Auth_PasswordBind_FullMethodName     = "/layout.api.layout.auth.v1.Auth/PasswordBind"
)
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "layout.api.layout.auth.v1.Auth",
	...
	Metadata: "api/layout/auth/application_auth_service.proto",
}
